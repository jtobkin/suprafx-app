 ...
 return (
  <div ref={ref} className="relative">
   ...
   <button onClick={() => setOpen(!open)}
    className="flex items-center gap-2 px-3 transition-colors w-full"
   ...
   {open && (
    <div className="absolute top-full left-0 mt-1 overflow-hidden z-[100] animate-slide-down"
    ...
    <div className="flex items-start gap-3 flex-wrap justify-center">
     ...
     <div style={{ width: 120 }}>
      ...
      <input type="number" step="0.01" min="0" placeholder="0.00" value={amount}
       ...
       className="w-full px-3 mono text-[14px] outline-none"
     ...
     <div style={{ width: 160 }}>
      ...
      <div className="flex items-center overflow-hidden" style={{ border: "1px solid var(--border)", height: 46 }}>
     ...
     <div style={{ width: 220 }}>
      ...
      <div className="flex items-center px-3" style={{ background: "var(--surface-2)", border: "1px solid var(--border)", height: 46, overflow: "hidden" }}>
     ...
     <div>
      ...
      <button onClick={submit} disabled={loading || parsedAmount <= 0 || parsedPrice <= 0}
       className="px-5 text-[13px] font-semibold transition-all disabled:opacity-30 hover:brightness-110 whitespace-nowrap"
